...
Cette carte consolide l'etat du projet apres la cloture du cercle 2 des
...
La v1.3 integre le resultat du cercle 2 :
...
```text
la question directrice n'est plus seulement :
de quelle famille releve cette grandeur ?

Elle devient :
comment cette grandeur est-elle stabilisee, dans quel regime,
par quel acces, selon quelle trajectoire, et avec quelles limites ?
```

### 3. Deplacement depuis la v1.2
...
```text
la v1.3 ne remplace pas la methode ;
elle en donne l'etat synthetique apres reprise positive.
```

### 4. Grammaire v1.3

Toute fiche ou synthese active doit suivre l'ordre suivant :
...
Ils ne doivent pas etre forces en classes exclusives.

### 6. Architectures actives apres cercle 2
...
La temporalite devient un axe general, mais elle prend des formes locales.
...
Le regime d'acces doit etre explicite dans tout document actif.

| Type d'acces | Role | Prudence |
|---|---|---|
| Mesure directe ou ajustement | Stabilise une valeur ou un spectre | Schema, precision, contexte experimental |
| Realisation pratique | Rend une definition utilisable | Incertitude de realisation |
...
Les termes historiques restent disponibles, mais avec statut controle.
...
```text
les anciens termes ne sont pas interdits ;
ils ne doivent plus commander la structure des nouveaux documents.
```

### 10. Documents actifs apres v1.3
...
6. mise a l'epreuve par exemples porteurs v0.1.
```
