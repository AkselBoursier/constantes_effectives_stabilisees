...
| Cercle 2 des architectures actives | `04_ARCHITECTURES_INTER_FAMILLES/Cercle2_architectures_actives_v0_1.md` | Ouverture produite ; lot 2A produit |
...
```text
soit le lot 2B de reprise positive metrologique SI,
