...
1. [Standard d’évaluation](../01_CADRE_METHODOLOGIQUE/Note_standard_evaluation_contribution_v0_1.md)
2. [Carte de migration](../05_CARTES_ET_SYNTHESES/Carte_migration_originalite_vers_contribution_v0_1.md)

## Dossier 1 — Stern–Gerlach

1. [Entrée historique du pilote](PILOTE_Q1_STERN_GERLACH_README.md)
2. [Cadrage physique](Pilote_Q1_Stern_Gerlach_cadrage_physique_v0_1.md)
3. [Matrice fonctionnelle](Pilote_Q1_Stern_Gerlach_matrice_fonctions_v0_1.md)
4. [Séquences d’axes — protocole](Pilote_Q1_Stern_Gerlach_sequence_axes_protocole_v0_1.md)
5. [Séquences d’axes — verdict](Pilote_Q1_Stern_Gerlach_sequence_axes_verdict_v0_1.md)

Rang : calibration correcte et premier matériau de contribution sur les relations entre préparation, sélection, mesure, trace et attribution.

## Dossier 2 — Interférence et marquage des voies

1. [Cadrage physique et conversation](Pilote_Q1_interference_cadrage_v0_1.md)
